...
ELSE 
  ...
  END
SELECT @ReturnID=CustomerID FROM Customers c WHERE c.CustomerID = @CustomerID --Llenado de la variable de retorno con el CustomerID que se insertó o actualizó (el que se le pasó)
END
